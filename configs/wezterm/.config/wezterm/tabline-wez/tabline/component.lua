...
local util = require('tabline-wez.tabline.util')
local config = require('tabline-wez.tabline.config')
local extension = require('tabline-wez.tabline.extension')
local mode = require('tabline-wez.tabline.components.window.mode')
...
local function create_sections(window)
	...
	tabline_c = insert_component_separators(util.extract_components(sections.tabline_c, attributes_c, window, true),
		true)
	tabline_x = insert_component_separators(util.extract_components(sections.tabline_x, attributes_x, window, true),
		false)
	tabline_y = insert_component_separators(util.extract_components(sections.tabline_y, attributes_y, window, true),
		false)
	tabline_z = insert_component_separators(util.extract_components(sections.tabline_z, attributes_z, window, true),
		false)
end
